...
while True:
    ...
    if ids is not None:
        ...
        rvec_list_all, tvec_list_all = aruco.estimatePoseSingleMarkers(corners, marker_size, camera_matrix, camera_distortion)
        ...
        cv2.putText(frame, tvec_str, (40,460), cv2.FONT_HERSHEY_PLAIN, 2, (0,255,255), 2, cv2.LINE_AA)
